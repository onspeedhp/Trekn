            ...
            >
              <div className='flex-col'>
                ...
                <div className='text-[13px] text-[#848484] font-medium mb-4'>
                  {selectedLocation.location_name} ∙ {selectedLocation.location}
                </div>
                ...
                <div className='font-medium	text-black opacity-50 mb-20'>
                  ...
                  tradition and modernity, where the city comes alive under the
                  glow of the full moon. The air is filled with the sweet aroma
                  of mooncakes, a customary delicacy, and the laughter of
                  children as they parade colorful lanterns through the streets.
                  Families gather around intricately laid-out altars to offer
                  fruits and other treats to the Moon Goddess, while folklore
                  performances and dragon dances captivate audiences young and
                  old...
                </div>
