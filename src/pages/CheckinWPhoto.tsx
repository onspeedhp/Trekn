        ...
        <>
            <div className='bg-black min-h-screen'>
                <div className='p-5 text-white font-semibold'>
                    ...
                    <div className="mb-6 mx-auto rounded-xl relative flex items-center justify-center bg-[#1F1F1F]" style={{
                        ...
                        {files ?
                            <>
                                ...
                                />
                                <FaTimesCircle size={24} className='absolute right-[-14px] top-[-16px] opacity-70' onClick={() => setFiles(null)} />
                            </>
                            :
                            <>
                                <input
                    ...
                    <div className="flex items-center justify-between">
                        <Button
                            className='bg-[#2C2C2C] text-white py-3 px-16 h-auto rounded-3xl font-semibold text-base border-0'
                        >
                            Cancel
                        </Button>
                        <Button
